...
An alternative to the standard multiprocessing libraries that handles working
with macOS better. Entirely taken from
<https://gist.github.com/FanchenBao/d8577599c46eab1238a81857bb7277c9>.

Authors:
    Víctor Terrón <https://github.com/vterron>
    Fanchen Bao <https://github.com/FanchenBao>
    Yvan Satyawan <https://github.com/yvan674>
"""
...
class Queue(queues.Queue):
    ...
    For documentation of using __getstate__ and __setstate__ to serialize
    objects, refer to here:
